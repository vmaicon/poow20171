 ...
 * @author Laboratorio
 */
@WebServlet(name = "AddAlunoServlet", urlPatterns = {"/addAluno"})
public class AddAlunoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        a.setIdade(Integer.valueOf(request.getParameter("idade")));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        int id = Integer.valueOf(request.getParameter("remover"));
        Aluno aluno = listAluno.get(id);
